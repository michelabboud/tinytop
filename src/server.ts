...
const PUBLIC_DIR = new URL("../agent/assets/dashboard", import.meta.url).pathname;
const ECHARTS_VENDOR = new URL("../agent/assets/dashboard/vendor/echarts.min.js", import.meta.url).pathname;
