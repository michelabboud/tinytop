...
> Current status note, 2026-06-25: this is the historical initial
> implementation plan. The dashboard assets created under `public/` in this
> plan now live in `agent/assets/dashboard/` for the embedded Rust daemon and
> `legacy/dashboard/` for the legacy Bun fallback.
