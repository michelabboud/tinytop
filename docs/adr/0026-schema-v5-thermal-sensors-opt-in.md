...
**Proposed (2026-08-30)** — Task 17 of plan `docs/plans/2026-08-16-sensors-recording-plan.md` (its **first slice**; see that plan's 2026-08-30 amendment). Decisions 1, 2 and 6 are the three questions the T17 fact sheet §D left open and **await Michel's ruling before the lane is dispatched.** Extends ADR 0021 (cadence classes), ADR 0024/0025 (typed history, the interning pattern) and ADR 0015 (the opt-in settings block shape).
